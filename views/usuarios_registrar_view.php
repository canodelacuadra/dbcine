<div class='row'>
    <div class="col-md-4 offset-md-4 border border-primary mt-3 p-3 shadow-lg rounded">
        <h2 class="text-center">Registro Usuarios BdCine</h2>
        <?php
        //recojemos mensaje del modelo
        if (isset($mensaje)) : ?>
            <div class=" alert alert-primary" role="alert">
                <p> <?php echo $mensaje ?></p>
                <p>Ya estás registrado. Puedes <br><a class='btn btn-outline-success' href="/peliculas">ir a peliculas</a></p>
            </div>
        <?php
        endif; ?>
        <form class="row g-3" method="post">
            ...
            <div class="mb-3 col-12 mx-auto">
                <label class='form-label text-center' for="usuario">usuario</label>
                <input autofocus class='form-control' name="usuario" id="usuario" type="text">
